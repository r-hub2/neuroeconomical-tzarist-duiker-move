...
setClass(
  Class = ".unUsedRecordsStack", contains = ".unUsedRecords", # maybe at somestage introduce checking of duplicate timestamps in unused records
  representation = representation(
...
setClass(
  Class = ".MoveTrack", contains = c("SpatialPointsDataFrame"),
  representation = representation(
    timestamps = "POSIXct",
    idData = "data.frame",
    sensor = "factor"
...
setClass(
  Class = ".MoveTrackSingle", contains = c(".MoveTrack", ".unUsedRecords"),
  representation = representation(),
  prototype = prototype(),
  validity = function(object) {
...
setClass(
  Class = "Move", contains = c(".MoveTrackSingle", ".MoveGeneral"),
  representation = representation(),
  prototype = prototype(),
  validity = function(object) {
    return(TRUE)
...
setClass(
  Class = ".MoveTrackStack", contains = c(".MoveTrack", ".unUsedRecordsStack"),
  representation = representation(
    trackId = "factor"
  ),
  prototype = prototype(
  ...
  validity = function(object) {
    ...
    if (any(unlist(tapply(object@timestamps, list(trackId(object), droplevels(object@sensor)), diff)) == 0)) {
...
setClass(
  Class = "MoveStack", contains = c(".MoveTrackStack", ".MoveGeneral"),
  representation = representation(),
  prototype = prototype(),
  validity = function(object) {
    return(TRUE)
...
setClass(
  Class = ".MoveTrackSingleBurst", contains = c(".MoveTrackSingle"),
  representation = representation(
    burstId = "factor"
  ),
  prototype = prototype(
...
setClass(
  Class = "MoveBurst", contains = c(".MoveTrackSingleBurst", ".MoveGeneral"),
  validity = function(object) {
    return(TRUE)
  }
)
...
setClass(
  Class = "dBMvariance", contains = c(".MoveTrackSingle", "dBMvarianceTmp"),
  validity = function(object) {
...
setClass(
  Class = "dBMvarianceBurst", contains = c(".MoveTrackSingleBurst", "dBMvarianceTmp"),
  validity = function(object) {
    if (length(object@means) != nrow(object@coords)) {
      stop("Number of coordinates does not match the number of means")
    }
...
setClass(
  Class = "dBMvarianceStack", contains = c(".MoveTrackStack", "dBMvarianceTmp"),
  validity = function(object) {
    if (length(object@means) != nrow(object@coords)) {
      stop("Number of coordinates does not match the number of means")
    }
...
setClass(
  Class = ".UDStack", contains = c("RasterStack"),
...
setClass(
  Class = ".UDBurstStack", contains = c("RasterStack"),
  slots = c(method = "character"),
  prototype = prototype(
    method = as.character()
  ),
...
setClass(
  Class = "DBBMMStack", contains = c(".UDStack"),
  representation = representation(
...
setClass(
  Class = "DBBMMBurstStack", contains = ".UDBurstStack",
  representation = representation(
...
## dynBGB classes ##
setClass(
  Class = "dBGBvarianceTmp",
  representation = representation(
    windowSize = "numeric",
    margin = "numeric", paraSd = "numeric", orthSd = "numeric", nEstim = "numeric",
    segInterest = "logical"
  ), prototype = prototype(
    windowSize = numeric(), margin = numeric(),
    paraSd = numeric(), orthSd = numeric(), nEstim = numeric(), segInterest = logical()
  ),
  validity = function(object) {
    if (length(unique(c(
      length(object@paraSd), length(object@orthSd), length(object@nEstim),
      length(object@segInterest)
    ))) != 1) {
...
setClass(
  Class = "dBGBvariance", contains = c(".MoveTrackSingle", "dBGBvarianceTmp"),
  validity = function(object) {
